...
imgTargets.forEach((img)=>{
    _lazyLoadingJs.imgObserver.observe(img);
});
// REVEAL SECTIONS
allSections.forEach(function(section) {
    _lazyLoadingJs.sectionObserver.observe(section);
// section.classList.add("section--hidden");
});
// READ BLOGS SECTION
if (newsBlog) newsBlog.forEach((news)=>{
    _renderBlogsJs.renderBlogs(news);
});

},{"./renderBlogs.js":"beEMT","./lazyLoading.js":"4EV9h"}],"beEMT":[function(require,module,exports) {
...
const renderBlogs = async (element = null)=>{
    ...
    let colors;
    // fetch blogs
    const blogs = await _fetchBlogsJs.fetchBlogs(element);
    //show error if it fails
    if (!blogs.success) {
        _utilitiesJs.loadMessage(`${blogs.message}  🚩`, element);
        return;
    }
...
},{"./fetchBlogs.js":"jPcPM","./utilities.js":"f4wib","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jPcPM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const fetchBlogs = async (element = null)=>{
    _utilitiesJs.loadMessage("Loading...🚀", element);
    try {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["grteY","4pp4s"], "4pp4s", "parcelRequiref153")
