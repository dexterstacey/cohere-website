...
var _renderBlogsJs = require("./renderBlogs.js");
...
imgTargets.forEach((img)=>{
    (0, _lazyLoadingJs.imgObserver).observe(img);
});
// REVEAL SECTIONS
allSections.forEach(function(section) {
    (0, _lazyLoadingJs.sectionObserver).observe(section);
// section.classList.add("section--hidden");
});
// READ BLOGS SECTION
if (newsBlog) newsBlog.forEach((news)=>{
    (0, _renderBlogsJs.renderBlogs)(news);
});

},{"./renderBlogs.js":"beEMT","./lazyLoading.js":"4EV9h","regenerator-runtime/runtime":"dXNgZ","core-js/modules/web.immediate.js":"49tUX"}],"beEMT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderBlogs", ()=>renderBlogs);
...
const renderBlogs = async (element = null)=>{
    ...
    let colors;
    // fetch blogs
    const blogs = await (0, _fetchBlogsJs.fetchBlogs)(element);
    //show error if it fails
    if (!blogs.success) {
        (0, _utilitiesJs.loadMessage)(`${blogs.message}  🚩`, element);
        return;
    }
...
const filterArr = (arr, category)=>{
    const returnedArray = arr.filter((blog)=>blog.category.includes(category)).slice(0, 3);
...
const fetchBlogs = async (element = null)=>{
    (0, _utilitiesJs.loadMessage)("Loading...\uD83D\uDE80", element);
    try {
...
},{"./utilities.js":"f4wib","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"f4wib":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loadMessage", ()=>loadMessage);
"use strict";
const loadMessage = (message, element)=>{
    element.innerHTML = "";
    let html;
...
},{}],"4EV9h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sectionObserver", ()=>sectionObserver);
parcelHelpers.export(exports, "imgObserver", ()=>imgObserver);
"use strict";
//-------------------
// Lazy Load Sections
...
},{"../internals/export":"dIGt4","../internals/global":"i8HOC","../internals/task":"7jDg7"}]},["2Rsls","4pp4s"], "4pp4s", "parcelRequiref153")
